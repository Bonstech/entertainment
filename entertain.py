...
def scrape_articles():
    ...
    url = 'https://www.ghanaweb.com/GhanaHomePage/entertainment/'  # The URL to scrape
    try:
...
def display_articles():
    ...
    return render_template('entertain.html', articles=scraped_articles)
...
def view_article(article_id):
    ...
    if article_url:
        try:
            ...
            return render_template('entertaincont.html', content=article_content, image=full_img_url)
